...
function print_data(id) {
    ...
    fetch(api)
        ...
        .then(data => {
            ...
            imgElement.className = "picture_recipe";
            ingredients_of_recipe_container.appendChild(imgElement);
            ...
            div_buttons.appendChild(add_button);

            //מחיקת סועדים
            var remove_button = document.createElement("button");
            remove_button.className = "remove_button";
            remove_button.innerHTML = "&#8722";
            remove_button.addEventListener('click', function () {
                diners = remove_diners((diners), (data));
                servings.innerHTML = diners + " SERVINGS";
            });
            div_buttons.appendChild(remove_button);
